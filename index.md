...
Gaze-Enabled Tracking | this is one way of selecting items in a VR space, the user uses two crosshairs in the VR space to select items by looking at the item and ensuring the crosshairs are on the item and then holding their gaze on the item for a few seconds
